  ...
  <div class="page wrapper">
    ...
    <div class="account-container">
      <!-- <div class="account-header">
        <h2 class="title">帳戶總資產 <span class="sub-title">( 美股帳戶 <i
          v-if="this.$store.state.settingForm.indexDisplay">+ 指數帳戶</i> <i
          v-if="this.$store.state.settingForm.futuresDisplay"> + 期貨帳戶</i>)</span></h2>
        <div>
        ...
        <div class="iconfont">
          <mt-button class="btn-red pull-right" size="small" type="danger" @click="toCash">Withdrawal</mt-button>
          <mt-button class="btn-red pull-right" size="small" type="danger" @click="toRecharge">Recharge</mt-button>
        </div>
        <mt-progress
        ...
        <div class="acc-pre-left">
          ...
          <span class="de">
            <div>
              ...
              <!-- <p v-else-if="this.$store.state.settingForm.indexDisplay && this.$store.state.settingForm.futuresDisplay"
                class="account">{{$store.state.hide?'****':
                formartAmount(Number($store.state.userInfo.userAmt +$store.state.userInfo.userIndexAmt +
