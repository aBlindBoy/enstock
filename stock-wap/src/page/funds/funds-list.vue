<template>
  <div class="wrapper">
    <mt-navbar class="top-navbar" v-model="selected" fixed>
      <mt-tab-item
      class="top-nav-item" id="1">my allocation</mt-tab-item>
      <mt-tab-item
      class="top-nav-item" id="2">Funding positions</mt-tab-item>
      <mt-tab-item
      class="top-nav-item" id="3">Allotment and liquidation</mt-tab-item>
    </mt-navbar>
