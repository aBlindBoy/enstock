        ...
        <li v-for="(item) in list" :key="item.key">
          <div class="order-info-box">
            ...
            <div class="order-info">
              ...
              <p class="clearfix">
                <span class="col-xs-4">Total profit and loss:<b class="space">{{item.sellOrderPrice}}</b></span>
                <span class="col-xs-8 text-center">Buy time:<b class="space">{{new Date(item.buyOrderTime) | timeFormat}}</b></span>
              </p>
