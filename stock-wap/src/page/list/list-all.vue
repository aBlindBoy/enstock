<!-- <template>
  <div>
    <div v-if="false" class="account-box">
      <div class="header">
        <i style="color:#ff7602" class="iconfont icon-zhishuyidong"></i>US stocks
        <a class="pull-right" @click="toStock()">More<i class="iconfont icon-you"></i></a>
      </div>
      <div class="content">
        <div class="box page-part">
          <div class="box-contain clearfix">
            <div :class="i.floatPoint<0?'tab greenBg':'tab redBg'" v-for="(i,index) in stockList" 
                 :key="i.key">
                 <div v-if="index < 6">
    ...
    <div v-if="this.$store.state.settingForm.kcStockDisplay" class="account-box">
      ...
      <div class="content">
        <div class="box page-part">
          <div class="box-contain clearfix">
            <div :class="i.floatPoint<0?'tab ':'tab '" v-for="(i,index) in stockKechuangList" 
                 :key="i.key">
              <div v-if="index < 6">
                <p :index='index' class="name">{{i.name}}</p>
                  <p 
    ...
    <div v-if="this.$store.state.settingForm.futuresDisplay" class="account-box">
      <div class="header">
        ...
        v-show="$state.theme == 'red'"
        >
        <span style="flex:1">futures</span>
      ...
      <div class="content">
        <div class="box page-part">
          <div class="box-contain clearfix">
            <div :class="i.floatPoint<0?'tab greenBg':'tab redBg'" v-for="(i,index) in futuresList" 
                 :key="i.key">
                 <div v-if="index < 3">
