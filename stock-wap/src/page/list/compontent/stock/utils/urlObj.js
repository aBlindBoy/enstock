...
const assemblUrl = function(url){
    var pageDomain = {
        ...
        isDeBug: true  //给張航：true,发布测试服务器：false
    };
...
const urlObj = {
    ...
    // htmlPay:assemblUrl("/pay.html"),//Recharge
    ...
    // htmlPayHistory:assemblUrl("/payHistory.html"),//历史Recharge
    ...
    // apiBalance:assemblOPEN('/API/StockHistoryDay'),  //融资融券餘额
    ...
    // apiGetCostList: assemblApi("/api/GetCostList"),//Recharge商品价格列表
    // apiRechargeLog: assemblApi("/api/RechargeLog"),//历史Recharge
