  ...
  <div class="wrapper"> 
    ...
    <div class="box-tab">
      ...
      <div class="tab-con">
        ...
        <p class="clearfix">
          <span class="pull-left">Minimum available for purchase  {{Number(detail.minNum)}} share</span>
    ...
    <div class="box-tab">
      <div class="tab-title">
        ...
        <span class="notify">Maximum purchase amount:{{settingInfo.buyMaxPercent * $store.state.userInfo.enableIndexAmt}}</span>
      </div>
      <div class="tab-con">
        <ul class="radio-group clearfix">
    ...
    <div class="agree">
      <p style="line-height: 0.4rem;padding: 0 0.2rem;">
        When the index rises to<span class="red">daily limit</span>When, can not bullish; reach<span class="green">Limit down</span>When not bearish.
      </p>
      <!-- <p>
