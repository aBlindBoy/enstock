<template>
  <div class="wrapper">
    ...
    <div class="alert-box">
      Disclaimer: The opinions in this article only represent the author's personal opinions and do not constitute investment advice on the platform. The platform does not make any guarantees for the accuracy, completeness and timeliness of the article, and is not responsible for any losses caused by the use or reliance of the article information. .
    </div>
  </div>
</template>
