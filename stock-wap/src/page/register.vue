  ...
  <div class="wrapper">
    <div class="register-form">
      ...
      <!-- <div class="register-form-item input-model">
        ...
        <input class="register-input" style="width:1.4rem" placeholder="驗證碼" type="tel" pattern="[0-9]*" v-model="code">
        <div v-if="codeshow" class="getcode" @click="checkCodeBox">獲取驗證碼</div>
    ...
    <!-- <i class="iconfont icon-yonghu"></i>
      ...
      <div class="form-view" v-if="$store.state.siteInfo.smsDisplay">
        ...
        <span v-if="codeshow" class="getcode" @click="checkCodeBox">獲取驗證碼</span>
    ...
    <!-- <i class="iconfont icon-lr_password"></i>
        <input type="password" placeholder="密碼為6~12位，數字、字母或符號" v-model="psd">
      </div>
      <div class="form-view"> -->
    <!-- <icon class="form-ic" name="safe" slot="icon"></icon> -->
    <!-- <i class="iconfont icon-lr_password"></i>
        <input type="password" placeholder="請再次確認密碼" v-model="psd2">
      </div>
      <div class="form-view">
        <i class="iconfont icon-tuijian"></i>
        <input type="text" v-model="invitecode" placeholder="輸入機構代碼">
      </div>
    </div>
    <div class="chebox">
      <i @click="isAgree"
         :class="agree?'glyphicon glyphicon glyphicon-ok-sign red':'glyphicon glyphicon-ok-circle'"></i>
      我已閱讀併同意
      <a @click="toagreeUrl">《註冊協議》</a>
    </div>
    <div class="btnbox">
      <span class="btnok" @click="gook">確定</span>
    </div>
    <div class="back">
      已有帳戶？<a href="javascript:;" @click="goLogin">返回登入</a>
    </div> -->
