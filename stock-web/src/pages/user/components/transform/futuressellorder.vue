                ...
                <el-form label-position="left" inline class="demo-table-expand">
                  <div class="expand-row">
                    <p v-if="props.row.orderDirection === 'Bullish'">
                      ...
                      {{props.row.coinCode}} ≈ {{props.row.profitAndLose * props.row.coinRate}} USD
                    </p>
                    <p v-else>
                      Floating profit and loss：-( {{props.row.sellOrderPrice}} - {{props.row.buyOrderPrice}} ) * {{props.row.orderNum}} *
                      {{props.row.eachPoint}} = {{(-(props.row.sellOrderPrice -
                    ...
                    <p>
                      Total profit and loss：({{props.row.profitAndLose}} - {{props.row.orderFee}}) = {{props.row.profitAndLose -
                  ...
                  <el-form-item label="Handling fee">
                    <span>{{ props.row.orderFee}} {{props.row.sellRate}} ≈ {{ (props.row.orderFee * props.row.coinRate).toFixed(2)}} USD</span>
                  </el-form-item>
                  <el-form-item label="Quantity">
                    <span>{{ props.row.orderNum}}</span>
                  </el-form-item>
                  <el-form-item label="selling rate">
                    <span>1{{props.row.sellRate}} ≈ {{ props.row.coinRate}}USD</span>
                  </el-form-item>
