      ...
      <el-table
          ...
          <template slot-scope="props">
            <div class="rule">
              <p v-if="props.row.orderDirection == '买涨'">
                ...
                {{props.row.coinCode}} ≈ {{props.row.profitAndLose * props.row.sellRate}} USD
              </p>
              <p v-else>
                浮动盈亏：-( {{props.row.sellOrderPrice}} - {{props.row.buyOrderPrice}} ) * {{props.row.orderNum}} *
                {{props.row.futuresStandard}} = {{(-(props.row.sellOrderPrice -
              ...
              <p>
                ...
                props.row.orderFee}} {{props.row.coinCode}} ≈ {{props.row.allProfitAndLose * props.row.sellRate}} USD
              </p>
            </div>
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="手续费">
                <span>{{ props.row.orderFee}} {{props.row.coinCode}} ≈ {{ (props.row.orderFee * props.row.sellRate).toFixed(2)}} USD</span>
              </el-form-item>
              <el-form-item label="数量/手">
                <span>{{ props.row.orderNum}}</span>
              </el-form-item>
              <el-form-item label="卖出汇率">
                <span>1{{props.row.coinCode}} ≈ {{ props.row.sellRate}}USD</span>
              </el-form-item>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <p>≈{{(scope.row.profitAndLose * scope.row.sellRate).toFixed(2)}} USD
            </p>
          </template>
        </el-table-column>
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <p>≈{{(scope.row.allProfitAndLose * scope.row.sellRate).toFixed(2)}} USD
            </p>
          </template>
        </el-table-column>
        <!-- <el-table-column
