        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <div class="bounceIn tab-number">
              ...
              <p class="mini-font">≈{{(scope.row.profitAndLose * scope.row.coinRate).toFixed(2)}} USD</p>
            </div>
          </template>
        </el-table-column>
        <el-table-column
          ...
          <template slot-scope="scope">
            <div class="bounceIn tab-number">
              ...
              <p class="mini-font">≈{{(scope.row.allProfitAndLose * scope.row.coinRate).toFixed(2)}} USD</p>
            </div>
          </template>
        </el-table-column>
