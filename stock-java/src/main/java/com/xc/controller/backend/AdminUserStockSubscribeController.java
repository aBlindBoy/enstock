...
//    }
    ...
    //新股申购-更新
    @RequestMapping({"updateStockSubscribe.do"})
    @ResponseBody
    public ServerResponse updateStockSubscribe(UserStockSubscribe model) {
        return this.iUserStockSubscribeService.update(model);
    }
