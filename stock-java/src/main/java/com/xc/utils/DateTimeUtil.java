...
public class DateTimeUtil {
    ...
    public static String dateToStamp(String time){
        ...
        if (!"".equals(time)) {//時间不為空
            ...
            long current_time = System.currentTimeMillis();  //获取當前時间
    ...
    public static String getStampNow() {
        Long startTs = System.currentTimeMillis(); // 當前時间戳
    ...
    public static Date doEndTime(Date begintime, int month) {
        ...
        log.info("计算時间 传入時间 = {} , 時间戳 = {}", dateToStr(begintime), begintimelong);
        ...
        log.info("endtime 時间戳 = {},時间 = {} , 格式化時间={}", new Object[]{endtimelong, endtimedate,
    ...
    public static boolean sameDate(Date d1, Date d2) {
        ...
        //fmt.setTimeZone(new TimeZone()); // 如果需要設置時间区域，可以在这里設置
