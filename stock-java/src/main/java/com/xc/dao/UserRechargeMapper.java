...
public interface UserRechargeMapper {
  ...
  UserRecharge selectByOrderNo(String order_sn);
  ...
  List<UserRecharge> listByAdmin(@Param("agentId") Integer paramInteger1, @Param("userId") Integer paramInteger2, @Param("realName") String paramString, @Param("state") Integer paramInteger3, @Param("begin_time") Date paramDate1, @Param("end_time") Date paramDate2);
