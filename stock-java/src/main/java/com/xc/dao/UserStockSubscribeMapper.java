...
public interface UserStockSubscribeMapper {
    ...
    List<UserStockSubscribe> getStockSubscribeHistoryList(@Param("pageNum") int pageNum, @Param("pageSize") int pageSize, @Param("userId") Integer userId);

    List<UserStockSubscribe> selectUserSubscribeByDrawDate(String date);

    UserStockSubscribe getById(Integer id);
}
