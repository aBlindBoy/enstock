...
public interface UserMapper {
    ...
    List listByAdmin(@Param("realName") String paramString1, @Param("phone") String paramString2,
                     @Param("searchId") Integer paramInteger1, @Param("isActive") String isActive, @Param("accountType") Integer paramInteger2);
...
//    @Update("update `user` set user_amt = user_amt + #{user_amt} where id = #{user_id}")
    ...
    List<User> listByAgentId(@Param("agentId")  Integer agentId);
}
