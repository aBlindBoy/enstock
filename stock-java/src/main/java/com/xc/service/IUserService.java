...
//  void ForceSellOneStockTask();
  ...
  ServerResponse listByAdmin(String paramString1, String paramString2, Integer paramInteger1, Integer paramInteger2, String isActive, int paramInt1, int paramInt2, HttpServletRequest paramHttpServletRequest);
