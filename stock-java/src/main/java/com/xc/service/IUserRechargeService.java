...
public interface IUserRechargeService {
  ...
  ServerResponse inMoney(String paramString1, String paramString2, String imgUrl, HttpServletRequest paramHttpServletRequest) throws Exception;
  ...
  ServerResponse updateState(String paramInteger1, Integer paramInteger2) throws Exception;
  ...
  ServerResponse updateMoney(String orderSn, String imgUrl, HttpServletRequest request);
}
