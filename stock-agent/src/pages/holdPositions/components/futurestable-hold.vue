    ...
    <div class="table">
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <p>
              ...
              <span class="mini-font">{{scope.row.userId}}</span>
            </p>
        ...
        <el-table-column
          ...
          label="买入点数">
          <template slot-scope="scope">
            {{scope.row.buyOrderPrice}} {{scope.row.coinCode}}
          </template>
        </el-table-column>
        <el-table-column
          prop="nowPrice"
          ...
          <template slot-scope="scope">
            <div v-if="scope.row.nowPrice"
              ...
              <p
                ...
                {{scope.row.nowPrice == 0?'-':Number(scope.row.nowPrice).toFixed(2)}} {{scope.row.coinCode}}
              </p>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <div class="bounceIn tab-number">
              ...
              <p class="mini-font">
                ≈ {{(scope.row.profitAndLose * scope.row.coinRate).toFixed(2)}} USD
              </p>
            </div>
          </template>
        </el-table-column>
        <el-table-column
          ...
          <template slot-scope="scope">
            <div class="bounceIn tab-number">
              ...
              <p class="mini-font">
                ≈ {{(scope.row.allProfitAndLose * scope.row.coinRate).toFixed(2)}} USD
              </p>
            </div>
            <!-- <el-tag
      ...
      if (data.status === 0) {
        data.data.list.forEach((element, i) => {
          ...
          if (data.data.list[i].nowPrice !== this.list.list[i].nowPrice) {
            ...
            // if(i/2 == 1){
            //   this.list.list[i].nowPrice = Number(this.list.list[i].nowPrice) + 1
            // }else{
